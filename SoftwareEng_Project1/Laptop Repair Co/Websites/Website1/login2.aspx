<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login2.aspx.cs" Inherits="_Default" %>
...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
			...
			<li><a href="#" class="active">Supervisors Login Page</a>&nbsp;&nbsp;&nbsp; </li>
			<li><a href="login3.aspx" >Manager Login Page</a></li>
